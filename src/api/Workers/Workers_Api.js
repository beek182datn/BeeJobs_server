    ...
    if (req.method === "GET") {
        try {
            ...
            if (findWorker) {
                ...
                let {user_id, worker_name, worker_avatar, phone, email, major, experience, address } = findWorker;
                return res.status(200).json({
                    worker_info: { user_id ,worker_name, worker_avatar, phone, email, major, experience, address },
